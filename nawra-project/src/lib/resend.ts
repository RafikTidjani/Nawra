...
export async function sendOrderConfirmation(order: Order) {
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:'Nunito',system-ui,sans-serif;max-width:560px;margin:0 auto;color:#3D3228;">
        <div style="background:#3D3228;padding:32px;text-align:center;">
          <h1 style="font-family:'Cormorant Garamond',Georgia,serif;font-size:28px;color:#FFFBF9;margin:0;letter-spacing:0.25em;font-weight:600;">VELORA</h1>
          <p style="color:rgba(250,250,248,0.5);font-size:11px;letter-spacing:0.15em;margin:8px 0 0;">COIFFEUSES PREMIUM</p>
        </div>
        <div style="padding:32px;background:#FFFBF9;">
          <h2 style="font-size:24px;color:#3D3228;margin:0 0 8px;">Ta commande est confirmée !</h2>
          <p style="color:#8B7E75;font-size:14px;line-height:1.8;margin:0 0 24px;">
          ...
          <div style="background:#fff;border:1px solid rgba(0,0,0,0.07);border-radius:12px;padding:20px;margin-bottom:20px;">
            <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
              <span style="color:#8B7E75;font-size:13px;">Référence</span>
              <strong style="font-size:13px;">#${order.id?.slice(0,8)}</strong>
            </div>
            <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
              <span style="color:#8B7E75;font-size:13px;">Articles</span>
            ...
            <div style="display:flex;justify-content:space-between;">
              ...
              <strong style="font-size:20px;color:#D4A59A;">${total}€</strong>
            </div>
          </div>
          <p style="color:#8B7E75;font-size:13px;line-height:1.8;">
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:'Nunito',system-ui,sans-serif;max-width:560px;margin:0 auto;color:#3D3228;">
        ...
        <div style="padding:32px;background:#FFFBF9;">
          <h2 style="font-size:24px;color:#3D3228;margin:0 0 8px;">Ta commande est en route !</h2>
          <p style="color:#8B7E75;font-size:14px;line-height:1.8;margin:0 0 24px;">
            Bonjour ${order.customer.name},<br/>
          ...
          <div style="background:#fff;border:1px solid rgba(0,0,0,0.07);border-radius:12px;padding:20px;margin-bottom:20px;">
            <div style="margin-bottom:12px;">
              <span style="color:#8B7E75;font-size:13px;display:block;margin-bottom:4px;">Numéro de suivi</span>
              <strong style="font-size:16px;">${trackingNumber}</strong>
            </div>
            <a href="${carrierUrl}" style="display:inline-block;background:#3D3228;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:500;">
              Suivre mon colis
            </a>
          </div>
          <p style="color:#8B7E75;font-size:13px;line-height:1.8;">
        ...
        <div style="background:#3D3228;padding:20px;text-align:center;">
          <p style="color:rgba(250,250,248,0.4);font-size:11px;margin:0;">
            L'équipe VELORA — <span style="color:#D4A59A;">contact@velorabeauty.fr</span>
          </p>
        </div>
      </div>
    `,
